...
const App = () => {
    ...
    function handlePublish() {
        ...
        //排序
        if (type === 'hot') {
            setList(_.orderBy(newList, 'like', 'desc'));
        } else if (type === 'time') {
            setList(_.orderBy(newList, 'ctime', 'desc'))
        }
                            ...
                            <div className="content-wrap">
                                ...
                                <div className="root-reply">
                                    ...
                                    <div className="reply-info">
                                        ...
                                        {
                                            showDelBtn(item.user.uid) &&
                                            <span className="delete-btn" onClick={() => del(item.rpid)}>删除</span>
                                        }
                                    </div>
                                </div>
                            </div>
